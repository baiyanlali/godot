...
# ./bin/godot.macos.editor.arm64 --test gdscript-tokenizer test_prev.gd
# ./bin/godot.macos.editor.arm64 --test gdscript-parser test_prev.gd
./bin/godot.macos.editor.arm64 --test gdscript-compiler test_prev.gd
